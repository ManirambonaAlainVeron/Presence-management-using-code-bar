...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
            ...
            <div style="margin:25px;">
                <fieldset style="height:300px; padding:20px; color:#042331; border:solid 2px #042331; width:auto">
             ...
             <div id="un" style="float:left">
                <div id="id_personnel" style="float:left; margin-right:20px">
                    <asp:TextBox ID="NomTextBox" runat="server" placeholder="Nom" Height="25px" Width="210px" Font-Size="Medium"  ></asp:TextBox><br /><br />
                    <asp:TextBox ID="PrenomTextBox" runat="server" placeholder="Prenom" Height="25px" Width="210px" Font-Size="Medium" ></asp:TextBox><br /><br />
                    <asp:TextBox ID="NaissanceDatePicker" runat="server" placeholder="Prenom" Height="25px" Width="210px" Font-Size="Medium" TextMode="Date" ></asp:TextBox><br /><br />
                    <div>
                        <asp:DropDownList ID="Genre_ComboBox" runat="server" placeholder="Prenom" Height="25px" Width="103px" Font-Size="Medium" AutoPostBack="True" >
                        ...
                        <asp:DropDownList ID="EtatCivil_ComboBox" runat="server" placeholder="Prenom" Height="25px" Width="103px" Font-Size="Medium" >
                    ...
                    <div>
                        <asp:DropDownList ID="Identite_Type_ComboBox" runat="server" placeholder="Type d'identite" Height="25px" Width="126px" Font-Size="Medium"  OnSelectedIndexChanged="Identite_Type_ComboBox_SelectedIndexChanged" AutoPostBack="True">
                        ...
                        <asp:TextBox ID="IdentiteNumberTextBox" runat="server" placeholder="Numero" Height="25px" Width="80px" Font-Size="Medium" ></asp:TextBox>
                    </div><br />
                    <asp:TextBox ID="PhoneTextBox" runat="server" placeholder="Telephone" Height="25px" Width="210px" Font-Size="Medium"  TextMode="Phone"></asp:TextBox>
                </div>
                <div id="adresse" style="float:right;">
                    <asp:TextBox ID="EmailTextBox" runat="server" placeholder="Email" Height="25px" Width="210px" Font-Size="Medium" TextMode="Email" ></asp:TextBox><br /><br />
                    <asp:DropDownList ID="Region_ComboBox" runat="server"  Height="25px" Width="210px" Font-Size="Medium"  OnSelectedIndexChanged="Region_ComboBox_SelectedIndexChanged" AutoPostBack="True">
                    ...
                    <asp:TextBox ID="PaysTextBox"  runat="server" placeholder="Pays" Height="25px" Width="210px" Font-Size="Medium"></asp:TextBox><br /><br />
                    <asp:TextBox ID="ProvinceTextBox"  runat="server" placeholder="Province" Height="25px" Width="210px" Font-Size="Medium"></asp:TextBox><br /><br />
                    <asp:TextBox ID="CommuneTextBox"  runat="server" placeholder="Commune" Height="25px" Width="210px" Font-Size="Medium"></asp:TextBox><br /><br />
                    <asp:TextBox ID="ZoneTextBox"  runat="server" placeholder="Zone" Height="25px" Width="210px" Font-Size="Medium"></asp:TextBox><br />
                </div>
               </div>
             <div id="deux" style="float:right;margin-left:20px">
                <div style="float:left">
                    <div>
                        <asp:TextBox ID="EtablissementTextbox" runat="server"  placeholder="Etablissement" Height="25px" Width="145px" Font-Size="Medium"></asp:TextBox>
                        <asp:TextBox ID="PromotionTextbox" runat="server"  placeholder="Promotion" Height="25px" Width="60px" Font-Size="Medium"></asp:TextBox>
                    </div><br />
                    <asp:TextBox ID="SectionTextBox" runat="server" placeholder="Section"  Height="25px" Width="210px" Font-Size="Medium"></asp:TextBox><br /><br />
                    <div>
                        <asp:TextBox ID="NoteClasseTextbox" runat="server" placeholder="Note classe"  Height="25px" Width="102px" Font-Size="Medium"></asp:TextBox>
                        <asp:TextBox ID="NoteExetatTextBox" runat="server" placeholder="Note extat"  Height="25px" Width="102px" Font-Size="Medium"></asp:TextBox>
                    </div><br />
                    <div>
                        <asp:TextBox ID="NoteTestMedecineTextBox" runat="server" placeholder="Note Medecine"  Height="25px" Width="102px" Font-Size="Medium"></asp:TextBox>
                        <asp:TextBox ID="NoteSynthesetextBox" runat="server" placeholder="Note Synthese" Height="25px" Width="102px" Font-Size="Medium" ></asp:TextBox>
                    </div><br />
                    <asp:DropDownList ID="Hebergement_ComboBox" runat="server" Height="25px" Width="210px"  Font-Size="Medium" OnSelectedIndexChanged="Hebergement_ComboBox_SelectedIndexChanged">
                    ...
                    <asp:DropDownList ID="Boursier_ComboBox" runat="server"  Height="25px" Width="210px"  Font-Size="Medium" OnSelectedIndexChanged="Boursier_ComboBox_SelectedIndexChanged" AutoPostBack="True">
                ...
                <div id="check_box" style="float:right; margin-left:15px; width:300px">
                    ...
                    <div style="margin-left:5px" >
                        ...
                        <div style="float:right">
                            <asp:Label ID="Label4" runat="server" Text="Terminées ou susp."></asp:Label>
