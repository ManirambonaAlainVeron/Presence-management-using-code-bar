<%@ Page Title="" Language="C#" MasterPageFile="~/_Enseignements/EnseignementsMasterPage.Master" AutoEventWireup="true" CodeBehind="pointage.aspx.cs" Inherits="BMDSysWeb._Enseignements.pointage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlace" runat="server">
    <div>
        <asp:TextBox ID="num_pointe" runat="server" Width="400px" OnTextChanged="num_pointe_TextChanged" autofocus="autofocus" Style="margin-top: 30px; text-align: center; margin-left: 250px" AutoComplete="off" BorderStyle="Solid" BorderColor="#003399"></asp:TextBox>
    </div>
    <div runat="server" id="MainDiv" style="margin-top: 30px; text-align: center; margin-left: 0px;">
